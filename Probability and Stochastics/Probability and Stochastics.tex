...
\begin{itemize}[nosep]
  ...
  \item 如果一列子集 $A_n\in \mathcal{A}$，那么
  \[
    \bigcap_{n\in \mathbb{N}}A_n=\Bigl(\bigcup_{n\in \mathbb{N}}A_n\Bigr) ^c\in \mathcal{A}.
  \]
...
\begin{proposition}[测度的性质]
  ...
  \begin{enumerate}
    ...
    \[
      \mu\Bigl(\bigcup_{n\in \mathbb{N}}A_n\Bigr)  
      =\lim_{n\to\infty}\mu(A_n).
    \]
    \item 如果 $B_n\in \mathcal{A}$ 且 $B_{n+1}\subseteq B_n$，
    $\mu(B_1)<\infty$，那么
    \[
      \mu\Bigl(\bigcap_{n\in \mathbb{N}}B_n\Bigr)  
      =\lim_{n\to\infty}\mu(B_n).
    \]
    \item 如果 $A_n\in \mathcal{A}$，那么
    \[
      \mu\Bigl(\bigcup_{n\in \mathbb{N}}A_n\Bigr)\leq \sum_{n\in \mathbb{N}}\mu(A_n).
    \]
  \end{enumerate}
\end{proposition}
\begin{proof}
  ...
  \[
    \mu\Bigl(\bigcup_{n\in \mathbb{N}}A_n\Bigr)  
    =\mu\Bigl(\bigcup_{n\in \mathbb{N}}C_n \Bigr)
